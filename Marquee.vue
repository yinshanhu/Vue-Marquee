<template>
  <div class="seamless-scrolling">
    <div ref="SSSList" class="seamless-list-group" @touchstart="stopAnimation" @touchmove="moveAnimation"
         @touchend="runningAnimation" :style="`flex-direction:${flexDirection}`">
      <div class="seamless-list-container" :style="`flex-direction:${flexDirection};`">
        <slot></slot>
        <slot name="holder" v-if="list.length === 0" ></slot>
      </div>
      <div class="seamless-list-container" v-if="showCopy && !unlimited"
